# Delayed Acknowledgment (Burst Mode)

Tango ADB supports a delayed acknowledgment (Delayed ACK, a.k.a [Burst Mode](https://developer.android.com/tools/adb?utm_source=android-studio-app&utm_medium=app#burstMode)) feature to improve throughput, especially over high-latency connections like Wi-Fi.
...
In Tango ADB, delayed ack can be configured by the [`initialDelayedAckBytes`](../tango/daemon/connect-device/index.mdx#initialdelayedackbytes) option during the ADB connection setup.
