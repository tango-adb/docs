...
- ISO/IEC MPEG-4 AVC standard (https://www.iso.org/obp/ui/en/#iso:std:iso-iec:14496:-10:ed-10:v1:en) uses varies C structure-like format to store those packets. This format is commonly referred to as "avcC", and used by various containers.
...
H.265/HEVC is very similar to H.264. It's also a joint effect between ITU-T and ISO, and it also has two formats, Annex B (identical to H.264) and HEVC (similar to avcC but with different fields).
