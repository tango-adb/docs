...
The [`MediaRecorder`](https://developer.mozilla.org/en-US/docs/Web/API/MediaRecorder) API can record the rendering canvas (from [H264BSD decoder](./tiny-h264.mdx) or [WebCodecs decoder](./webcodecs/index.mdx#create-a-renderer)) into a MP4 or WEBM file.
