...
If some of them are disabled by options (<Version since="v2.1">[`video: false`](./options/video.mdx)</Version>, <Version since="v2.0">[`audio: false`](./options/audio.mdx)</Version>, <Version since="v1.22">and [`control: false`](./options/control.mdx)</Version>), the corresponding socket will be skipped, but the order of other sockets will be kept.
