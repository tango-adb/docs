...
In all situations, the `tunnelForward` option can be specified to always use forward tunnels. For more details about this option, see the [tunnelForward option](./options/tunnel-forward.mdx) page:
