...
This option allows specifying a custom session identifier that can be used to distinguish between multiple Scrcpy sessions running simultaneously. The session ID is typically represented as a hexadecimal string.
