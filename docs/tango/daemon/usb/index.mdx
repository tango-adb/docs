...
Google ADB solves this problem by using a server program that forwards ADB commands to devices for multiple clients. Tango supports the [Server Transport](../../server/index.mdx) to connect to the server and to have shared access to the device.
