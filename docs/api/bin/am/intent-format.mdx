...
| `extras`     | `Record<string, any>` | Additional key-value pairs to pass with the intent         |
...
- Objects: `ComponentName`, `IntentStringExtra`, `IntentNumberExtra`
- Arrays: `IntentStringArrayExtra`, `IntentNumberArrayExtra`
...
- **Type**: `IntentNumberArrayExtra` or `IntentStringArrayExtra`
- **Properties**:
